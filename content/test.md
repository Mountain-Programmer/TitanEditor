...
{
public:
	class gentity_t* ent; //0x0000
	char pad_0004[12]; //0x0004
	int32_t bOriginChanged; //0x0010
	vec3_t oldOrigin; //0x0014
	float maxVisibleDist; //0x0020
	char pad_0024[4]; //0x0024
	int32_t attackerCount; //0x0028
	char pad_002C[84]; //0x002C
	int32_t inuse; //0x0080
...
public:
	...
	vec2_t angles; //0x003C
	char pad_0044[248]; //0x0044
	class gclient_t* client; //0x013C
	char pad_0140[4]; //0x0140
	class Sentient_t* sentient; //0x0144
	char pad_0148[60]; //0x0148
	int32_t health; //0x0184
	int32_t maxHealth; //0x0188
	char pad_018C[836]; //0x018C
}; //Size: 0x04D0
...
typedef void(__cdecl* G_Damage_t)(int a1, int* a2, int* attackerArg, int a4, int a5, signed int damageArg, int a7, int a8, int a9, int a10, int a11, int a12);
typedef WeaponVariantDef* (__cdecl* BG_GetWeaponVariantDef_t)(int weap_idx); // 00444740; 
typedef int(__cdecl* BG_GetNumWeapons_t)(); // 00425770

typedef Sentient_t* (__fastcall* Sentient_FirstSentient_t)(int iTeamFlags);
typedef Sentient_t* (__fastcall* Sentient_NextSentient_t)(Sentient_t* pPrevSentient, int iTeamFlags);
typedef int(__cdecl* G_DObjGetWorldTagPos_t)(gentity_t* ent, unsigned int tagName, vec3_t* pos);

typedef void(__cdecl* G_DObjUpdate_t)(gentity_t* ent);
...
namespace Engine
{
	...
	extern BG_GetWeaponVariantDef_t BG_GetWeaponVariantDef; // // 00444740; 
	extern BG_GetNumWeapons_t BG_GetNumWeapons;
	// use to iterate sentient list
	extern Sentient_FirstSentient_t Sentient_FirstSentient; // 0x004DEAF0
	extern Sentient_NextSentient_t  Sentient_NextSentient;	// 0x005E4100
	extern G_DObjGetWorldTagPos_t G_DObjGetWorldTagPos;
	extern G_DObjUpdate_t G_DObjUpdate;
	// Structure instances
	extern cg_t* cg;
